  ...
  actions: {
    ...
    async updateProfile(profileData) {
      try {
        ...
        const updatedUser = {
          ...this.users[index],
          ...profileData,
          avatar: `https://ui-avatars.com/api/?name=${encodeURIComponent(profileData.name || this.users[index].name)}`
        };
    ...
    async updateUser(userId, userData) {
      ...
      const updatedUser = {
        ...fakeUsers[index],
        ...userData,
        avatar: `https://ui-avatars.com/api/?name=${encodeURIComponent(userData.name || fakeUsers[index].name)}`
      };
