  ...
  <main>
    <section>
      <div class="w-100 position-relative">
        <div
          class="feat-wrap4 pt-150 pb-140 black-layer position-relative opc3 w-100"
        >
          <div
            class="fixed-bg"
                ...
                <div class="row mrg">
                  <div class="col-md-6 col-sm-6 col-lg-6">
                    ...
                    >
                      ...
                      <div class="city-info3 position-absolute w-100">
                        <h3 class="mb-0">
                          <a href="place-listing.html" title="">Sport Events</a>
                        </h3>
                        <span class="d-inline-block thm-clr"
                ...
                <div class="row mrg">
                  <div class="col-md-6 col-sm-6 col-lg-6">
                    ...
                    >
                      ...
                      <div class="city-info3 position-absolute w-100">
                        <h3 class="mb-0">
                          <a href="place-listing.html" title="">Gym & Health</a>
                        </h3>
                        <span class="d-inline-block thm-clr"
                  ...
                  <div class="col-md-6 col-sm-6 col-lg-6">
                    ...
                    >
                      ...
                      <div class="city-info3 position-absolute w-100">
                        <h3 class="mb-0">
                          <a href="place-listing.html" title="">Nightlife</a>
                        </h3>
                        <span class="d-inline-block thm-clr"
                          ><i class="fas fa-glass-cheers"></i>2 Events
                          Available</span
    ...
    <section>
      <div class="w-100 pt-140 gray-layer3 pb-120 opc65 position-relative">
        ...
        <div class="container">
          <div class="sec-title text-center w-100">
            <span class="d-block thm-clr"
              >You can choose to display featured</span
            >
            ...
            <div class="listing-post-box3 v3 d-flex flex-wrap w-100">
              ...
              <div class="list-post-info3">
                ...
                <p class="mb-0">
                  ...
                  BloomsburyLuxury hotel in the heart of BloomsburyLuxury hotel
                  in the heart
                </p>
                <ul
                  class="post-meta d-inline-flex flex-wrap mb-0 list-unstyled"
                >
                  <li>
        ...
        <div class="container">
          <div class="video-wrap text-center w-100">
            <div class="video-inner d-inline-block">
              ...
              <p class="mb-0">
                Keep calm and get a special discount for all orders over $50
                from The Naturel Coffee. Hurry up! Only 3 days left.
              </p>
                  ...
                  <div class="list-post-box2 position-relative w-100">
                    ...
                    >
                      ...
                      >
                        ...
                        ><span class="list-post-rate text-color2"
                          ...
                          ><i class="fas fa-star"></i><i class="fas fa-star"></i
                          ><i class="fas fa-star"></i><span>4.5</span></span
                        >
                      </div>
                    </div>
                    <div class="list-post-info2 w-100">
                      ...
                      <ul class="post-meta mb-0 list-unstyled w-100">
                        <li>
                          <i class="fas fa-map-marker-alt rounded-circle"></i>95
                          South Park Avenue
                        </li>
                        <li>
                          <i class="fas fa-phone rounded-circle"></i>+61 2 8236
                          9200
                        </li>
                      </ul>
                      <a
        ...
        <div class="container">
          <div class="stats-wrap res-row w-100">
            <div class="row">
              <div class="col-md-6 col-sm-6 col-lg-4">
                <div
                  class="stats-box w-100 d-flex flex-wrap align-items-center"
                >
