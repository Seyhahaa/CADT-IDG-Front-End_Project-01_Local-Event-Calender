                                ...
                                <div class="col-md-12 col-sm-12 col-lg-6">
                                    <div class="feat-cap5 w-100">
                                        ...
                                        <p class="mb-0">
                                            ...
                                            museums, art centers, theaters, and landmarks. Looking
                                            for a cozy hotel to stay, a restaurant to eat, a museum
                                            to visit or a mall to do some shopping
                                        </p>
                                    ...
                                    <div class="dir-form2-wrap text-right w-100">
                                        <form class="dir-form5 w-100">
                                            <div class="field w-100">
                                                <label
                                                    ><i class="fas fa-map-pin"></i>What you'd like
                                                    to find?</label
                                                >
                                                <input
                                                    type="text"
                                            ...
                                            <div class="field w-100">
                                                <label
                                                    ><i class="far fa-flag"></i>In which
                                                    category?</label
                                                >
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-lg-6">
                                    ...
                                    <ul class="post-meta d-flex flex-wrap mb-0 list-unstyled">
                                        <li>
                                            <i class="rounded-circle fas fa-glass-cheers"></i>3
                                            Events available
                                        </li>
                                        <li>
