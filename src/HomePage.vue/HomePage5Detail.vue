  ...
  <main>
    <div class="rspn-hdr">
      ...
      <div class="rsnp-mnu">
        ...
        <ul class="mb-0 list-unstyled w-100">
          ...
          <li class="menu-item-has-children">
            <a href="javascript:void(0);" title="">Listing</a>
            <ul class="children mb-0 list-unstyled">
              <li><a href="place-listing.html" title="">Place Listing</a></li>
              <li>
                <a href="listing-explore-map-sidebar.html" title=""
                  >Listing With Map Style 1</a
                >
              </li>
              <li>
                <a href="place-layout-detail.html" title=""
                  >Listing Detail Style 1</a
                >
              </li>
              <li>
                <a href="listing-explore-map-sidebar2.html" title=""
                  >Listing With Map Style 2</a
                >
              </li>
              <li>
                <a href="place-layout-detail2.html" title=""
                  >Listing Detail Style 2</a
                >
              </li>
    ...
    <section>
      <div class="w-100 position-relative">
        <div
          class="feat-wrap5 pt-150 pb-160 black-layer position-relative opc65 w-100"
        >
          <div
            class="fixed-bg"
            style="background-image: url(assets/images/resources/feat-bg5.jpg)"
          ></div>
          <div class="container">
                ...
                <div class="col-md-12 col-sm-12 col-lg-6">
                  <div class="feat-cap5 w-100">
                    <span class="d-block thm-clr"
                      >Explore all the Popular Places</span
                    >
                    <h2 class="mb-0">Find Places You Want to Go</h2>
                    <p class="mb-0">
                      We provide event and directory listings of restaurants,
                      museums, art centers, theaters, and landmarks. Looking for
                      a cozy hotel to stay, a restaurant to eat, a museum to
                ...
                <div class="col-md-12 col-sm-12 col-lg-6">
                  <div class="dir-form2-wrap text-right w-100">
                    <form class="dir-form5 w-100">
                      ...
                      <div class="field w-100">
                        <label
                          ><i class="far fa-flag"></i>In which category?</label
                        >
    ...
    <section>
      <div class="w-100 pt-140 dark-layer2 pb-120 opc9 position-relative">
        <div
          class="fixed-bg"
          style="background-image: url(assets/images/parallax5.jpg)"
        ></div>
        <div class="container">
            ...
            <div class="about-img-caro">
              <div class="about-img2">
                ...
                <img
                  ...
                  src="assets/images/resources/about-img2-1.jpg"
                  alt="About Image 1"
                />
              </div>
              <div class="about-img2">
                ...
                <img
                  class="img-fluid w-100"
                  src="assets/images/resources/about-img2-2.jpg"
                  alt="About Image 2"
                />
              </div>
            </div>
              ...
              <div class="row">
                <div class="col-md-12 col-sm-12 col-lg-6">
                  ...
                  <ul class="post-meta d-flex flex-wrap mb-0 list-unstyled">
                    <li>
                      <i class="rounded-circle fas fa-glass-cheers"></i>3 Events
                      available
                    </li>
                    <li>
                      <i class="rounded-circle fas fa-map-marker-alt"></i>95
                      South Park Avenue, China
                    </li>
                  </ul>
                </div>
                <div class="col-md-12 col-sm-12 col-lg-6">
                  <p class="mb-0">
                    Luxury hotel in the heart of BloomsburyLuxury hotel in the
                    heart of Bloomsbury Luxury hotel in the heart of
                    BloomsburyLuxury hotel in the heart of BloomsburyLuxury
                    hotel in the heart
                  </p>
    ...
    <section>
      <div class="w-100 pt-140 pb-140 position-ralative">
        <div class="container">
          ...
          <!-- Sec Title -->
          <div
            class="listing-top-bar d-flex flex-wrap align-items-center justify-content-between w-100"
          >
          ...
          <div class="listing-layout mt-30 w-100">
            <div class="row justify-content-center">
              <div class="col-md-6 col-sm-6 col-lg-3">
                <div
                  class="list-post-box v2 brd-rd5 overflow-hidden position-relative w-100"
                >
                  <div
                  ...
                  >
                    <img
                      class="img-fluid w-100"
                      src="assets/images/resources/list-post-img2-1-1.jpg"
                      alt="List Post Image 1"
                    />
                    <span class="list-post-cat2 position-absolute"
                      ><a
                        class="rounded-pill"
                    ...
                    <div class="list-post-inner w-100">
                      ...
                      >
                        <span class="list-post-date"
                          ><i class="thm-clr far fa-clock"></i>27 May 2020</span
                        >
                        <span class="list-post-rate text-color2"
                          ><i class="fas fa-star"></i><i class="fas fa-star"></i
                          ><i class="fas fa-star"></i><i class="fas fa-star"></i
                          ><i class="far fa-star"></i><span>4.0/5</span></span
                        >
                      </div>
                      <h3 class="mb-0">
                      ...
                      >
                        ...
                        >
                          <img
                            ...
                            src="assets/images/resources/author-img1-1.jpg"
                            alt="Author Image 1"
                          />
              ...
              <div class="col-md-6 col-sm-6 col-lg-3">
                ...
                >
                  ...
                  >
                    <img
                      class="img-fluid w-100"
                      src="assets/images/resources/list-post-img2-1-2.jpg"
                    ...
                    <div class="list-post-inner w-100">
                      ...
                      >
                        ...
                        >
                          <img
                            class="rounded-circle img-fluid"
                            src="assets/images/resources/author-img1-2.jpg"
                            alt="Author Image 2"
                          />
                          <span>By Master Event</span>
                        </div>
              ...
              <div class="col-md-6 col-sm-6 col-lg-3">
                ...
                >
                  ...
                  >
                    <img
                      class="img-fluid w-100"
                      src="assets/images/resources/list-post-img2-1-3.jpg"
                    ...
                    <div class="list-post-inner w-100">
                      ...
                      >
                        ...
                        >
                          <img
                            class="rounded-circle img-fluid"
                            src="assets/images/resources/author-img1-3.jpg"
                            alt="Author Image 3"
                          />
                          <span>By Master Event</span>
                        </div>
              ...
              <div class="col-md-6 col-sm-6 col-lg-3">
                ...
                >
                  ...
                  >
                    <img
                      class="img-fluid w-100"
                      src="assets/images/resources/list-post-img2-1-4.jpg"
                    ...
                    <div class="list-post-inner w-100">
                      ...
                      >
                        ...
                        >
                          <img
                            class="rounded-circle img-fluid"
                            src="assets/images/resources/author-img1-4.jpg"
                            alt="Author Image 4"
                          />
                          <span>By Master Event</span>
                        </div>
              ...
              <div class="col-md-6 col-sm-6 col-lg-3">
                ...
                >
                  ...
                  >
                    <img
                      class="img-fluid w-100"
                      src="assets/images/resources/list-post-img2-1-5.jpg"
              ...
              <div class="col-md-6 col-sm-6 col-lg-3">
                ...
                >
                  ...
                  >
                    <img
                      class="img-fluid w-100"
                      src="assets/images/resources/list-post-img2-1-6.jpg"
              ...
              <div class="col-md-6 col-sm-6 col-lg-3">
                ...
                >
                  ...
                  >
                    <img
                      class="img-fluid w-100"
                      src="assets/images/resources/list-post-img2-1-7.jpg"
                      alt="List Post Image 7"
                    />
                    <span class="list-post-cat2 position-absolute"
                      ><a
                        class="rounded-pill"
                    ...
                    <div class="list-post-inner w-100">
                      ...
                      >
                        ...
                        >
                          <img
                            class="rounded-circle img-fluid"
                            src="assets/images/resources/author-img1-7.jpg"
                            alt="Author Image 7"
                          />
                          <span>By Master Event</span>
                        </div>
              ...
              <div class="col-md-6 col-sm-6 col-lg-3">
                ...
                >
                  ...
                  >
                    <img
                      class="img-fluid w-100"
                      src="assets/images/resources/list-post-img2-1-8.jpg"
                      alt="List Post Image 8"
                    />
                    <span class="list-post-cat2 position-absolute"
                      ><a
                        class="rounded-pill"
                    ...
                    <div class="list-post-inner w-100">
                      ...
                      >
                        ...
                        >
                          <img
                            class="rounded-circle img-fluid"
                            src="assets/images/resources/author-img1-8.jpg"
                            alt="Author Image 8"
                          />
                          <span>By Master Event</span>
                        </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-lg-6 order-lg-1">
                <div class="event-conf-imgs w-100 position-relative">
                  <img
                    class="img-fluid"
                    src="assets/images/resources/event-conf-img1.jpg"
                    alt="Event Conf Image 1"
                  />
                  <img
                    class="img-fluid"
                    src="assets/images/resources/event-conf-img2.jpg"
                    alt="Event Conf Image 2"
                  />
                  <img
                    class="img-fluid"
                    src="assets/images/resources/event-conf-img3.jpg"
                    alt="Event Conf Image 3"
                  />
                </div>
              </div>
              <div class="col-md-12 col-sm-12 col-lg-6">
            ...
            <div class="row mrg5 justify-content-center">
              <div class="col-md-3 col-sm-4 col-lg-3">
                <div class="insta-box w-100">
                  <a
                    href="assets/images/resources/insta-img1.jpg"
                    data-fancybox="gallerry"
                    title=""
                    ><img
                      class="img-fluid w-100"
                      src="assets/images/resources/insta-img1.jpg"
              ...
              <div class="col-md-3 col-sm-4 col-lg-3">
                <div class="insta-box w-100">
                  <a
                    href="assets/images/resources/insta-img2.jpg"
                    data-fancybox="gallerry"
                    title=""
                    ><img
                      class="img-fluid w-100"
                      src="assets/images/resources/insta-img2.jpg"
              ...
              <div class="col-md-3 col-sm-4 col-lg-3">
                <div class="insta-box w-100">
                  <a
                    href="assets/images/resources/insta-img3.jpg"
                    data-fancybox="gallerry"
                    title=""
                    ><img
                      class="img-fluid w-100"
                      src="assets/images/resources/insta-img3.jpg"
              ...
              <div class="col-md-3 col-sm-4 col-lg-3">
                <div class="insta-box w-100">
                  <a
                    href="assets/images/resources/insta-img4.jpg"
                    data-fancybox="gallerry"
                    title=""
                    ><img
                      class="img-fluid w-100"
                      src="assets/images/resources/insta-img4.jpg"
              ...
              <div class="col-md-3 col-sm-4 col-lg-3">
                <div class="insta-box w-100">
                  <a
                    href="assets/images/resources/insta-img5.jpg"
                    data-fancybox="gallerry"
                    title=""
                    ><img
                      class="img-fluid w-100"
                      src="assets/images/resources/insta-img5.jpg"
              ...
              <div class="col-md-3 col-sm-4 col-lg-3">
                <div class="insta-box w-100">
                  <a
                    href="assets/images/resources/insta-img6.jpg"
                    data-fancybox="gallerry"
                    title=""
                    ><img
                      class="img-fluid w-100"
                      src="assets/images/resources/insta-img6.jpg"
              ...
              <div class="col-md-3 col-sm-4 col-lg-3">
                <div class="insta-box w-100">
                  <a
                    href="assets/images/resources/insta-img7.jpg"
                    data-fancybox="gallerry"
                    title=""
                    ><img
                      class="img-fluid w-100"
                      src="assets/images/resources/insta-img7.jpg"
              ...
              <div class="col-md-3 col-sm-4 col-lg-3">
                <div class="insta-box w-100">
                  <a
                    href="assets/images/resources/insta-img8.jpg"
                    data-fancybox="gallerry"
                    title=""
                    ><img
                      class="img-fluid w-100"
                      src="assets/images/resources/insta-img8.jpg"
                      alt="Instagram Image 8"
                  /></a>
                </div>
              </div>
            </div>
    ...
    <section>
      <div class="w-100 pt-130 dark-layer2 pb-100 opc1 position-relative">
        <div
          class="fixed-bg"
          style="background-image: url(assets/images/parallax6.jpg)"
        ></div>
        <div class="container">
          <div class="about-toggle-wrap w-100">
            <div class="row align-items-center">
              <div class="col-md-12 col-sm-12 col-lg-6">
                <img
                  class="img-fluid w-100"
                  src="assets/images/resources/about-img3.jpg"
                  alt="About Image 3"
                />
              </div>
              <div class="col-md-12 col-sm-12 col-lg-6">
          ...
          <ul class="clients-wrap d-flex flex-wrap mb-0 list-unstyled w-100">
            <div class="client-item">
              <a href="javascript:void(0);" title=""
                ><img
                  class="img-fluid"
                  src="assets/images/resources/client-img2-1.png"
                  alt="Client Image 1"
              /></a>
            </div>
            <div class="client-item">
              <a href="javascript:void(0);" title=""
                ><img
                  class="img-fluid"
                  src="assets/images/resources/client-img2-2.png"
                  alt="Client Image 2"
              /></a>
            </div>
            <div class="client-item">
              <a href="javascript:void(0);" title=""
                ><img
                  class="img-fluid"
                  src="assets/images/resources/client-img2-3.png"
                  alt="Client Image 3"
              /></a>
            </div>
            <div class="client-item">
              <a href="javascript:void(0);" title=""
                ><img
                  class="img-fluid"
                  src="assets/images/resources/client-img2-4.png"
                  alt="Client Image 4"
              /></a>
            </div>
            <div class="client-item">
              <a href="javascript:void(0);" title=""
                ><img
                  class="img-fluid"
                  src="assets/images/resources/client-img2-5.png"
                  alt="Client Image 5"
              /></a>
            </div>
          </ul>
