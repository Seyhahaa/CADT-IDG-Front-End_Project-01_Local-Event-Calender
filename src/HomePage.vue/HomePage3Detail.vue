  ...
  <main>
    <section>
      <div class="w-100 position-relative">
        <div
          class="feat-wrap3 pt-140 pb-120 black-layer position-relative opc7 w-100"
        >
          <div
            class="fixed-bg"
          ...
          <div class="container">
            <div class="feat-inner3 pt-180 text-center w-100">
              ...
              <form
                class="dir-form3 text-left d-flex flex-wrap align-items-end"
              >
                <div class="field">
                  <label>Explore</label>
        ...
        <div class="container">
          ...
          <div class="event-videos-wrap event-video-caro">
            <div class="event-video-box text-center">
              <div
                class="event-video-img overflow-hidden position-relative w-100"
              >
                <a
      ...
      <div class="w-100 pt-140 pb-100 position-relative">
        <div class="container">
          <div class="post-wrap2 w-100">
            ...
            <div
              class="post-box2 v2 rev d-flex flex-wrap align-items-center w-100"
            >
              <div class="post-img2">
                <img
                  class="img-fluid"
