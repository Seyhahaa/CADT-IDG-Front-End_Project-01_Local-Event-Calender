            ...
            <div class="py-6">
                ...
                <div class="mt-4 space-y-4">
                    <div class="flex items-start">
                        ...
                        <div class="ml-3">
                            <label for="emailUpdates" class="text-sm font-medium text-gray-700"
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3">
                            <label for="emailEvents" class="text-sm font-medium text-gray-700"
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3">
                            <label for="emailSecurity" class="text-sm font-medium text-gray-700"
            ...
            <div class="py-6">
                ...
                <div class="mt-4 space-y-4">
                    <div class="flex items-start">
                        ...
                        <div class="ml-3">
                            <label for="pushEvents" class="text-sm font-medium text-gray-700"
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3">
                            <label for="pushMessages" class="text-sm font-medium text-gray-700"
                                >Messages</label
                            >
                            <p class="text-sm text-gray-500">
