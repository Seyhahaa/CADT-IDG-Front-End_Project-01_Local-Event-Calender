      ...
      <dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        ...
        >
          <dt>
            ...
            <p class="ml-16 truncate text-sm font-medium text-gray-500">Active Events</p>
          </dt>
          <dd class="ml-16 flex items-baseline pb-6 sm:pb-7">
      ...
      <div class="mt-8">
        <div class="sm:flex sm:items-center">
          <div class="sm:flex-auto">
            ...
            <p class="mt-2 text-sm text-gray-700">Latest events and updates from your system.</p>
          </div>
        </div>
