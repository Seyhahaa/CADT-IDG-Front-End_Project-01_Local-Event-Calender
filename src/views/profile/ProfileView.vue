            ...
            <div class="grid grid-cols-1 gap-x-8 gap-y-8 pt-10 md:grid-cols-3">
                ...
                <div class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2">
                    <dl class="divide-y divide-gray-100">
                        ...
                        <!-- Interests -->
                        <div
                            v-if="userStore.userProfile.interests?.length"
                            class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6"
                        >
                        ...
                        <!-- Social Links -->
                        <div
                            v-if="userStore.userProfile.socialLinks"
                            class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6"
                        >
                            <dt class="text-sm font-medium leading-6 text-gray-900">
                                Social Links
                            ...
                            <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                                <div class="flex gap-4">
                                    <a
                                        v-for="(link, platform) in userStore.userProfile
                                            .socialLinks"
                                        :key="platform"
                                        :href="link"
                                        target="_blank"
                            ...
                            <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                ...
                                >
                                    <div class="flex flex-col gap-2">
                                        ...
                                        <div>
                                            Access Level: {{ userStore.userProfile.accessLevel }}
                                        </div>
                                    </div>
                                </dd>
                            </div>
