                ...
                <div class="mt-5 flex lg:ml-4 lg:mt-0">
                    <span class="hidden sm:block">
                        ...
                        >
                            <StarIcon
                                class="h-5 w-5 mr-2"
                                :class="{ 'fill-current': event.isFavorite }"
                                aria-hidden="true"
                            />
...
<script setup>
    ...
    const event = ref({
        ...
        description:
            "Join us for our annual technology conference featuring industry leaders and innovators. This year's conference will focus on emerging technologies, best practices, and future trends in software development.",
