    ...
    <div>
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                ...
                <p class="mt-2 text-sm text-gray-700">Browse and register for upcoming events.</p>
            </div>
        </div>
        ...
        <div class="mt-8">
            ...
            <div
                v-if="(currentTab === 'all' && hasRegisteredEvents) || currentTab === 'registered'"
                class="mb-8"
            >
                            ...
                            <div class="mt-4 flex items-center gap-2">
                                ...
                                <div class="flex flex-1 justify-end gap-2">
                                    <button
                                        ...
                                        :class="{
                                            'text-red-500': event.isFavorite,
                                            'text-gray-400': !event.isFavorite,
                                        }"
                                    >
                                        <StarIcon
                                            class="h-5 w-5"
