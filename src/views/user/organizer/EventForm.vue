    ...
    <div class="space-y-10 divide-y divide-gray-900/10">
      <div class="grid grid-cols-1 gap-x-8 gap-y-8 md:grid-cols-3">
        <div class="px-4 sm:px-0">
          <h2 class="text-base font-semibold leading-7 text-gray-900">{{ isEditing ? 'Edit Event' : 'Create Event' }}</h2>
          <p class="mt-1 text-sm leading-6 text-gray-600">
            {{ isEditing ? 'Update your event details.' : 'Create a new event and set its details.' }}
          </p>
        </div>
          ...
          <div class="px-4 py-6 sm:p-8">
            <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              ...
              <div class="col-span-full">
                ...
                <p class="mt-3 text-sm leading-6 text-gray-600">Write a detailed description of your event.</p>
              </div>
