    ...
    <div class="space-y-10">
      ...
      <div class="grid grid-cols-1 gap-x-8 gap-y-8 md:grid-cols-3">
        <div class="px-4 sm:px-0">
          <h2 class="text-base font-semibold leading-7 text-gray-900">Organizer Profile</h2>
          <p class="mt-1 text-sm leading-6 text-gray-600">
            Manage your organizer profile and information visible to event attendees.
          </p>
        </div>

        <form class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2" @submit.prevent="saveProfile">
          <div class="px-4 py-6 sm:p-8">
            <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              ...
              <div class="col-span-full">
                <label for="description" class="block text-sm font-medium leading-6 text-gray-900">Organization Description</label>
                <div class="mt-2">
                  <textarea
                    id="description"
              ...
              <div class="sm:col-span-4">
                <label for="phone" class="block text-sm font-medium leading-6 text-gray-900">Contact Phone</label>
                <div class="mt-2">
                  <input
                    type="tel"
                    id="phone"
              ...
              <!-- Social Media Links -->
              <div class="col-span-full">
                <label class="block text-sm font-medium leading-6 text-gray-900">Social Media Links</label>
                <div class="mt-2 space-y-4">
                  <div v-for="(platform, index) in socialPlatforms" :key="platform.id" class="flex gap-4">
                    <div class="w-1/3">
                      <select
              ...
              <!-- Logo Upload -->
              <div class="col-span-full">
                <label class="block text-sm font-medium leading-6 text-gray-900">Organization Logo</label>
                <div class="mt-2 flex items-center gap-x-3">
                  <UserCircleIcon v-if="!form.logo" class="h-12 w-12 text-gray-300" aria-hidden="true" />
