                ...
                <div class="feat-wrap2 w-100 position-relative">
                    <div class="feat-caro2">
                        <div class="feat-item">
                            <div
                                class="feat-img"
                                style="background-image: url(assets/images/resources/feat-img1.jpg)"
                            ></div>
                        </div>
                        <div class="feat-item">
                            <div
                                class="feat-img"
                                style="background-image: url(assets/images/resources/feat-img2.jpg)"
                            ></div>
                        </div>
                        <div class="feat-item">
                            <div
                                class="feat-img"
                                style="background-image: url(assets/images/resources/feat-img3.jpg)"
                            ></div>
                        </div>
                        <div class="feat-item">
                            <div
                                class="feat-img"
                                style="background-image: url(assets/images/resources/feat-img4.jpg)"
                            ></div>
                        </div>
                        <div class="feat-item">
                            <div
                                class="feat-img"
                                style="background-image: url(assets/images/resources/feat-img5.jpg)"
                            ></div>
                        </div>
                        <div class="feat-item">
                            <div
                                class="feat-img"
                                style="background-image: url(assets/images/resources/feat-img6.jpg)"
                            ></div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-lg-8">
                                <div class="event-detail-inner2 bg-white w-100 overlap205">
                                    ...
                                    <div class="event-detail-content-inner w-100">
                                        ...
                                        <p class="mb-0">
                                            <span
                                                >Quisque non dictum eros, Praesent porta vehicula
                                                arcu eu ornare.</span
                                            >
                                        ...
                                        <p class="mb-0">
                                            <span
                                                >Duis autem vel eum iriure dolor in hendrerit</span
                                            >
                                    ...
                                    <div class="event-detail-content-inner w-100">
                                        ...
                                        >
                                            <li>
                                                <span
                                                    ><i
                                                        class="rounded-circle fas fa-map-marker-alt"
                                                    ></i
                                            ...
                                            <li>
                                                <span
                                                    ><i class="rounded-circle fas fa-phone-alt"></i
                                                    >+61 2 8236 9200</span
                                                >
                                            </li>
                                            <li>
                                        ...
                                        <div class="toggle w-100" id="toggle">
                                            <div class="toggle-item w-100">
                                                ...
                                                <div class="toggle-content w-100">
                                                    <p class="mb-0">
                                                        Royal Park of America produces premium
                                                        branded and private label lubricants for
                                                        agriculture.
                                                    </p>
                                                </div>
                                            </div>
