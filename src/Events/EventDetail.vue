          ...
          <div class="feat-caro2">
            <div class="feat-item">
              <div
                class="feat-img"
                style="
                  background-image: url(assets/images/resources/feat-img1.jpg);
                "
              ></div>
            </div>
            <div class="feat-item">
              <div
                class="feat-img"
                style="
                  background-image: url(assets/images/resources/feat-img2.jpg);
                "
              ></div>
            </div>
            <div class="feat-item">
              <div
                class="feat-img"
                style="
                  background-image: url(assets/images/resources/feat-img3.jpg);
                "
              ></div>
            </div>
            <div class="feat-item">
              <div
                class="feat-img"
                style="
                  background-image: url(assets/images/resources/feat-img4.jpg);
                "
              ></div>
            </div>
            <div class="feat-item">
              <div
                class="feat-img"
                style="
                  background-image: url(assets/images/resources/feat-img5.jpg);
                "
              ></div>
            </div>
            <div class="feat-item">
              <div
                class="feat-img"
                style="
                  background-image: url(assets/images/resources/feat-img6.jpg);
                "
              ></div>
            </div>
          </div>
          <div class="feat-nav-caro">
            <div class="feat-nav-item">
              <img
                ...
                src="assets/images/resources/feat-nav-img1.jpg"
                alt="Featured Nav Image 1"
              />
            </div>
            <div class="feat-nav-item">
              <img
                class="img-fluid w-100"
                src="assets/images/resources/feat-nav-img2.jpg"
                alt="Featured Nav Image 2"
              />
            </div>
            <div class="feat-nav-item">
              <img
                class="img-fluid w-100"
                src="assets/images/resources/feat-nav-img3.jpg"
                alt="Featured Nav Image 3"
              />
            </div>
            <div class="feat-nav-item">
              <img
                class="img-fluid w-100"
                src="assets/images/resources/feat-nav-img4.jpg"
                alt="Featured Nav Image 4"
              />
            </div>
            <div class="feat-nav-item">
              <img
                class="img-fluid w-100"
                src="assets/images/resources/feat-nav-img5.jpg"
                alt="Featured Nav Image 5"
              />
            </div>
            <div class="feat-nav-item">
              <img
              ...
              <div class="col-md-12 col-sm-12 col-lg-8">
                <div class="event-detail-inner2 bg-white w-100 overlap205">
                  <div class="event-detail-info2 w-100">
                    ...
                    <span class="d-inline-block thm-clr">02-05 July 2020</span
                    ><i class="d-inline-block">California</i>
                  ...
                  <div class="event-detail-content-inner w-100">
                    ...
                    <p class="mb-0">
                      <span
                        ...
                        eu ornare.</span
                      >
                      Donec id egestas arcu. Suspendisse auctor ali condimentum
                      ligula ultricies cursus. Vestibulum vel orci vel lacus
                      rhoncus sagittis sed vitae mi. Pellentesque suil molestie
                      elit bibendum tincidunt semper. Aliquam ac volutpat risus.
                      In felis felis, posuere commodo aliquet amit eget,
                      sagittis sed turpis. Phasellus commodo turpis non nunc
                      egestas, et egestas felis pretium. Pellentesque suli
                      dignissim libero vitae tincidunt semper. Nam id ante nisi.
                      Nam sollicitudin, dolor non suscipit feugiat, nibh lacus
                      commodo metus, nec tempus dui velit sagittis velit.
                      Pellentesque elementum risus rhoncus justo porta, at
                      varius odio consequat. Duis non augue adipiscing, posuere
                      quam non, tempus urna.
                    </p>
                    <p class="mb-0">
                  ...
                  <div class="event-detail-content-inner w-100">
                    <h3>Location</h3>
                    <div
                      class="listing-loc-map place-map"
                      id="listing-loc-map"
                    ></div>
                    <ul
                      class="location-add-list mb-0 list-unstyled d-flex flex-wrap"
                    >
                      <li>
                        <span
                          ><i class="rounded-circle fas fa-map-marker-alt"></i
                          >484 Ellis St, San Francisco, CA 94102, United
                          States</span
                        >
                      </li>
                      <li>
                        <span
                          ><i class="rounded-circle fas fa-phone-alt"></i>+61 2
                          8236 9200</span
                        >
                      </li>
                      <li>
                        <span
                          ><i class="rounded-circle far fa-envelope"></i
                          >youremail@mail.com</span
                        >
                      </li>
                      <li>
                        <span
                          ><i class="rounded-circle fas fa-globe"></i
                        ...
                        >
                          <div class="event-organizer-box w-100">
                            ...
                            >
                              ...
                              <li>
                                <i class="fas fa-globe rounded-circle"></i
                                >www.yourwebsite.com
                              </li>
                            </ul>
                          </div>
