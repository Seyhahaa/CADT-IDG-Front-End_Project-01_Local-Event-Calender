                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-12 col-sm-12 col-lg-6">
                            <div class="about-desc w-100">
                                ...
                                <p class="mb-0">
                                    City Night Life is the largest and most trusted global directory
                                    connecting engaged couples with local wedding professionals.
                                </p>
                                <p class="mb-0">
                                    Maecenas semper dolor metus, a convallis ipsum condimentum ras
                                    eros ex, euismod vitae congue ullamcorper id ligula. Maecenas
                                    semper dolor metusm ras eros ex
                                </p>
            ...
            <div class="container">
                <div class="video-wrap text-center w-100">
                    <div class="video-inner d-inline-block">
                        ...
                        <p class="mb-0">
                            Keep calm and get a special discount for all orders over $50 from The
                            Naturel Coffee. Hurry up! Only 3 days left.
                        </p>
                    ...
                    <div class="simple-post w-100">
                        <div class="row align-items-center">
                            <div class="col-md-6 col-sm-12 col-lg-6">
                                <div class="simple-img position-relative rounded-circle">
                                    <img
                                        class="img-fluid rounded-circle"
                                        src="assets/images/resources/simple-post-img1.jpg"
                                        alt="Simple Post Image 1"
                                    />
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-12 col-lg-6">
                                <div class="simple-desc w-100">
                                    ...
                                    <p class="mb-0">
                                        4K resolution 360-degree camera, expanding Samsung’s overall
                                        virtual reality ecosystem. The new Gear 360 offers enhanced
                                        features for producing high-quality content, including a
                                        streamlined workflow.
                                    </p>
                                    <ul class="mb-0 list-unstyled w-100">
                                        <li>
                                            <i class="fas fa-check"></i>Enhanced Features for
                                            High-Quality 360 Content
                                        </li>
                                        <li>
                                            <i class="fas fa-check"></i>Always Stay Connected with
                                            360 Social Live Broadcast
                                        </li>
                                        <li>
                                            <i class="fas fa-check"></i>Expanded Compatibility for
                                            More 360 Experiences
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-6 col-sm-12 col-lg-6 order-md-1">
                                <div class="simple-img position-relative rounded-circle">
                                    <img
                                        class="img-fluid rounded-circle"
                                        src="assets/images/resources/simple-post-img2.jpg"
                                        alt="Simple Post Image 2"
                                    />
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-12 col-lg-6">
                                <div class="simple-desc w-100">
                                    ...
                                    <ul class="mb-0 list-unstyled w-100">
                                        <li>
                                            <i class="fas fa-check"></i>Hey Siri, remind me to water
                                            the plants
                                        </li>
                                        <li>
                                            <i class="fas fa-check"></i>Hey Siri, add apples to the
                                            grocery list
                                        </li>
                                        <li>
                                            <i class="fas fa-check"></i>Hey Siri, make it warmer
                                            downstairs
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-lg-4">
                            <div class="team-box w-100 overflow-hidden position-relative">
                                ...
                                <div class="team-info w-100 position-absolute">
                                    <h3 class="mb-0">
                                        <a href="javascript:void(0);" title="">David jame</a>
                                    </h3>
                ...
                <div class="testi-wrap text-center w-100">
                    <div class="testi-img-caro">
                        ...
                        <div class="testi-img">
                            <img
                                class="img-fluid rounded-circle"
                                src="assets/images/resources/testi-img1-4.jpg"
                    ...
                    <div class="testi-desc-caro">
                        <div class="testi-desc-item">
                            ...
                            <p class="mb-0">
                                Ash's tactics & books have helped me a lot in my understanding on
                                how social media advertising works.I can say that he is one of the
                                best development professionals i have dealt with so far. His
                                experience is great & he is such a great & pleasant person to work
                                with you are
                            </p>
                        </div>
                        <div class="testi-desc-item">
                ...
                <ul class="clients-list text-center mb-0 list-unstyled d-flex flex-wrap">
                    <li>
                        <a href="javascript:void(0);" title=""
                            ><img
                                class="img-fluid"
                                src="assets/images/resources/client-img1.png"
                                alt="Client Image 1"
                        /></a>
                    </li>
                    <li>
                        <a href="javascript:void(0);" title=""
                            ><img
                                class="img-fluid"
                                src="assets/images/resources/client-img2.png"
                                alt="Client Image 2"
                        /></a>
                    </li>
                    <li>
                        <a href="javascript:void(0);" title=""
                            ><img
                                class="img-fluid"
                                src="assets/images/resources/client-img3.png"
                                alt="Client Image 3"
                        /></a>
                    </li>
                    <li>
                        <a href="javascript:void(0);" title=""
                            ><img
                                class="img-fluid"
                                src="assets/images/resources/client-img4.png"
                                alt="Client Image 4"
                        /></a>
                    </li>
                    <li>
                        <a href="javascript:void(0);" title=""
                            ><img
                                class="img-fluid"
                                src="assets/images/resources/client-img5.png"
                                alt="Client Image 5"
                        /></a>
                    </li>
                </ul>
