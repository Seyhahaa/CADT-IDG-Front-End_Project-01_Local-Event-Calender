<template>
          ...
          <div class="row align-items-center">
            ...
            <div class="col-md-12 col-sm-12 col-lg-6">
              <div class="about-desc w-100">
                ...
                <p class="mb-0">
                  City Night Life is the largest and most trusted global
                  directory connecting engaged couples with local wedding
                  professionals.
                </p>
                <p class="mb-0">
              ...
              <div class="col-md-6 col-sm-12 col-lg-6">
                <div class="simple-desc w-100">
                  ...
                  <ul class="mb-0 list-unstyled w-100">
                    ...
                    <li>
                      <i class="fas fa-check"></i>Always Stay Connected with 360
          ...
          <div class="testi-desc-caro">
            <div class="testi-desc-item">
              ...
              <p class="mb-0">
                ...
                of the best development professionals i have dealt with so far.
                His experience is great & he is such a great & pleasant person
                to work with you are
              </p>
            </div>
            <div class="testi-desc-item">
              <h4 class="mb-0">Malujt Looeo</h4>
  ...
  <section>
    <div class="w-100 pb-120 position-relative">
      <div class="container">
        <ul
          class="clients-list text-center mb-0 list-unstyled d-flex flex-wrap"
        >
          <li>
              ...
              <div class="toggle w-100" id="toggle">
                <div class="toggle-item w-100">
                  ...
                  <div class="toggle-content w-100">
                    <p class="mb-0">
                      Royal Park of America produces premium branded and private
